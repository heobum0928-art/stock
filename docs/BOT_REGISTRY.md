# 봇 등록부 — 무엇이 실제 돈을 쓰는가 (2026-08-20 기준)
...
|---|---|---|---|---|---|
| `margin_short_trader.py` | 숏 | `mshort_fut`(선물) | 150 USDT | **있음** | 46건 완료, 51건 관문 대상. 파라미터 동결 중 |
| `margin_short_trader.py` | 숏 | `mshort`(마진) | 100 USDT | **없음** | 실거래 0건. 08-20에 캡이 540으로 자동상향돼 있던 것 원복 |
| `core_leveraged.py` | **롱** | `core_lev` | 100 USDT | **없음** | BTC 2배. 주석이 "모의"라 적혀 있었으나 실거래 |
