...
> ⚠️ **quietpump 사전등록↔코드 불일치 (2026-08-29 발견, 미해결)**: 사전등록 문서와
> 원본 봉인검정은 **48시간 보유**인데 `quietpump_long_paper.py:66`은 `HOLD_H = 24`다.
> 지금까지 쌓인 표본은 **검증받은 그 전략이 아니라 미검증 24h 변형**이다. 사용자 결정 대기 중.
