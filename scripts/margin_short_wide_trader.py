...
# ★ 2026-09-17 사용자 지시("신규진입 중단하자"): 다시 차단. 기존 포지션 관리는 유지.
...
HOLD_H = 48
STOP_PCT = 40.0           # 진입가 대비 +40% 상승 시 손절(2배 청산선 +50% 안쪽) — 원본과 동일(청산 규칙 불변 요청)
...
#   단 2026-08-31 백테스트는 무필터 -2.01% / 필터 +1.53%였다(09-02 재개 조건). 되돌리려면 True.
CUSUM_ENABLED = False
CUSUM_VOLWIN = 288
CUSUM_K = 0.3
